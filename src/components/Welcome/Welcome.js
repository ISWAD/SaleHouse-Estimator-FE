		...
		<div>
			<div className = "Welcome shadow-2">
				...
				<div>
					...
					The freely available dataset on <a href = "https://www.kaggle.com/c/house-prices-advanced-regression-techniques/data">Kaggele</a> 
					is used to train the estimator model.
