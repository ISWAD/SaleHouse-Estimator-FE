	...
	return(
		<div>
			<div className = "Welcome shadow-2">
				...
				<div>
					This is an intelligent web app, designed by <span>ISWAD</span> to estimate the compressive strength of concretes.
					The freely available dataset on <a href = "https://www.kaggle.com/pritech/concrete-compressive-strength">Kaggele</a> is used to train the estimator model.
